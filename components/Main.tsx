...
export const Main = (props: any) => {
  return (
    <section
      id="home"
      className=" w-[100vw] flex laptop:flex-col flex-col sm:py-16 mt-1 justify-center items-center mb-24"
    >
      ...
      <figure className="md:flex bg-[#000] rounded-xl p-3 mt-5 md:p-0 dark:bg-slate-800 items-center w-[60vw] flex flex-row ml-5">
